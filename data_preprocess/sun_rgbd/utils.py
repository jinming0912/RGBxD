...
def load_list(path_split):
    data = io.loadmat(path_split)
    sub_dirs_train = [dir_scene[0].replace("/n/fs/sun3d/data/SUNRGBD/", "") for dir_scene in data['alltrain'][0]]
    sub_dirs_test = [dir_scene[0].replace("/n/fs/sun3d/data/SUNRGBD/", "") for dir_scene in data['alltest'][0]]
